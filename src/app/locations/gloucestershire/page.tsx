...
export const metadata = {
  title: "Coach Hire Gloucestershire",
  description:
    "Premium coach and minibus hire for private groups in Gloucestershire. Euro 6 fleet (16–51 seats).",
};
  ...
  return (
    <section className="bg-secondary">
      <Container className="py-16">
        <h1 className="font-serif text-4xl text-charcoal sm:text-5xl">Coach Hire Gloucestershire</h1>
        <p className="mt-5 max-w-3xl text-base text-slate">
          Executive coach and minibus hire for private groups, tours, schools and events — with primary pickup across Gloucestershire.
        </p>
